...
4. **歴史事件（`event` 📜）**: 史実に即した分岐イベント。
   - **時系列昇順選択システム**: マップ生成時に全103件の史実メタデータ（発生年・月）に基づき、フロア進行度に合わせて必ず**歴史上で発生した年月の順（時系列昇順）**でコマが配置される。
...
5. **洋行商人（`shop` 💰）**: カード・レリックの調達、列強借款、不要札の削除。
6. **本陣休息（`rest` 🍵）**: HP回復、条約交渉、札の破棄。ボス直前フロアには確定で配置。
7. **決戦大陣（`boss` 🏯）**: 各幕の最終フロア（14または13）に君臨する巨大決戦ノード。

#### 4.3.3 グラフ生成アルゴリズム
1. フロアごとに 2〜3 個のノードを動的生成（`col` 座標 0, 1, 2）。
...
- **全103件の歴史事件と連動**: 全選択肢に `opinionChange`（-35% 〜 +35%）が設定され、選択時に動的に加減算される。

#### 4.7.2 5段階フェーズと戦況マトリクス
| 段階名 | メーター範囲 | 討幕派戦況 | 佐幕派戦況 | 主な効果 |
|---|---|---|---|---|
| **【幕威轟々】** | -100 〜 -50% | 🚨 強烈劣勢 | 🌟 絶大優勢 | 佐幕: 全攻撃+4/開幕防+10/敵脱力2/商人20%引/小判+25両<br>討幕: 毎ターン手札-1枚/敵剛力+4/敵開幕防+20/開幕脱力2/商人35%高騰 |
| **【佐幕優勢】** | -49 〜 -20% | ⚠️ やや劣勢 | ✨ やや優勢 | 佐幕: 全攻撃+2/開幕防+5/商人10%引/小判+10両<br>討幕: 敵剛力+1/商人10%高騰 |
| **【天下混迷】** | -19 〜 +19% | ⚖️ 拮抗 | ⚖️ 拮抗 | 両者: シールド獲得時+1/標準相場 |
| **【討幕高揚】** | +20 〜 +49% | ✨ やや優勢 | ⚠️ やや劣勢 | 討幕: 全攻撃+2/開幕防+5/商人10%引/小判+10両<br>佐幕: 敵剛力+1/商人10%高騰 |
| **【回天官軍】** | +50 〜 +100% | 🌟 絶大優勢 | 🚨 強烈劣勢 | 討幕: 全攻撃+4/開幕防+10/敵脱力2/商人20%引/小判+25両<br>佐幕: 毎ターン手札-1枚/敵剛力+4/敵開幕防+20/開幕脱力2/商人35%高騰 |

#### 4.7.3 強劣勢ペナルティ（目先の利益選択への抑止）
自軍と敵対する世論へ大きく傾斜（±50%超）した場合、手札が毎ターン4枚に制限され、敵は開幕シールド20と剛力+4を纏って出現。志士獲得や軍資金目当てで安易に仇敵有利の選択肢を選び続けるとランの継続が破綻する設計となっている。
